// Embedded English word list (~starter sample). Replace with a full 5k list as needed.
// To use your own list, replace the contents of this file with:
//   window.WORDS_EN_5K = ["able","about", ... ]; // 5,000+ lowercase English words

(function(){
  window.WORDS_EN_5K = [
    "able","about","above","accept","across","act","action","active","actual","add",
    "adopt","adult","after","again","against","age","agent","agree","ahead","air",
    ...
    "area","argue","arm","around","arrive","art","article","as","ask","assume",
    "at","attack","attention","author","avoid","away","baby","back","bad","bag",
    ...
    "big","bill","bird","bit","black","blood","blue","board","body","book",
    "born","both","box","boy","break","bring","brother","budget","build","building",
    "business","but","buy","by","call","camera","campaign","can","cancer","candidate",
    "capital","car","card","care","career","carry","case","cause","cell","center",
    "central","century","certain","certainly","chair","chance","change","character","charge","check",
    ...
    "development","die","difference","different","difficult","dinner","direction","director","discover","discussion",
    ...
    "product","production","professional","professor","project","property","protect","prove","provide","public",
